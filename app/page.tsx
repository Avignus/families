    ...
    <div className="relative min-h-[calc(100vh-3.5rem)] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl w-full mx-auto px-6 py-16 flex flex-col items-center gap-10">
        ...
        <div className="flex flex-col items-center gap-5 text-center">
          ...
          <div className="space-y-3">
            ...
            <p className="text-lg text-muted-foreground max-w-md mx-auto leading-relaxed">
              Una-se com amigos para financiar jogos na lista de desejos da Steam uns dos outros.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 w-full max-w-md">
          {[
            { icon: Users, label: "Famílias de jogadores", color: "hsl(258 82% 66%)" },
            { icon: Gift, label: "Contribuições parciais", color: "hsl(186 90% 48%)" },
            { icon: Zap, label: "Notificações em tempo real", color: "hsl(258 82% 80%)" },
            { icon: ShieldCheck, label: "Login seguro via Steam", color: "hsl(186 90% 60%)" },
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-muted-foreground">
            Autenticação segura via Steam OpenID 2.0 · sem senha
          </p>
        </div>
        ...
        <div className="w-full max-w-md rounded-lg border border-border/40 bg-muted/30 px-4 py-3">
          <p className="text-xs text-muted-foreground text-center leading-relaxed">
            As contribuições são registros contábeis. Compras reais são feitas diretamente na Steam.
